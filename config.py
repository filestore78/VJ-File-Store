...
BOT_TOKEN = environ.get("BOT_TOKEN", "6888893298:AAFUrggIfTmXbRAHQHfimpzpIBR7WIvc7xE")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "http://t.me/filesstest_bot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://Strange:Strange@cluster0.wpvqktw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002162922696"))
